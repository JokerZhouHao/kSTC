 ...
 * @since 2019年4月27日
 */
public class Term2PidNeighborsContainReachDisIndexBuilder2 implements Runnable{
	...
	public Term2PidNeighborsContainReachDisIndexBuilder2(String[] allTerms, int start, int end, QueryParams qParams, String pathTerm2PidNei, String pathCellidRtreeidOrPidWordsIndex,
